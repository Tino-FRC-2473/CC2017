...
public class DigitalInputDiagnoserCommand extends Command {
    ...
    public DigitalInputDiagnoserCommand(org.usfirst.frc.team2473.robot.DigitalInputDiagnoser.Type type, int trackedDeviceID, String digitalinputkey, String trackedDeviceEncoder, double range) {
